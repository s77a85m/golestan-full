    ...
    <section class="container flex flex-row-reverse items-center justify-between h-full">
        ...
        <div x-data="registerMenu">
            <button x-on:click="openmenu()" class="px-10 py-2 rounded-full shadow-md active:scale-90 bg-cyan-300 shadow-gray-400">
                <span class="font-serif text-sm font-bold ">ورود به سیستم</span>
            </button>
            <!-- signIn & singUp  -->
            ...
            <div x-show="openMenu"x-transition:enter="transition ease-out duration-500"
                ...
                <div x-on:click.away="closmenu()" class="relative border-2 border-gray-300 flex flex-col gap-3 p-3 bg-white rounded-md">
                    ...
                    <div class="flex justify-center gap-20">
                        <span x-on:click="loginForm()" x-cloak x-bind:class="{'bg-gray-300 rounded-md' : formType=='login'}" class="p-2 cursor-pointer text-style">ورود به سیستم</span>
                        <span x-on:click="registerForm()" x-cloak x-bind:class="{'bg-gray-300 rounded-md' : formType=='register'}" class="p-2 cursor-pointer text-style">ثبت نام دانشجو</span>
                    </div>
                    <!-- loginForm -->
                    <form x-show="formType=='login'" x-cloak id="loginForm" accept="#" class="w-[570px] flex  mt-10 gap-10 flex-col">
                        <div class="flex flex-row gap-2">
                            ...
                            <div class="flex flex-col gap-2 flex-none w-[380px]">
                                <div class="flex flex-row justify-end gap-1">
                                    <label for="uid" class="flex items-center text-style">نام کاربری:</label>
                                ...
                                <div class="flex flex-row justify-end gap-1">
                                    <label for="pass" class="flex items-center text-style">رمز عبور:</label>
                                ...
                                <div class="flex justify-start pr-[53px] gap-1 flex-row">
                                    <label for="capcha" class="flex items-center text-style">کد کپچا:</label>
                        ...
                        <div class="w-full flex-center">
                            <button class="px-10 py-2 text-white bg-green-600 rounded-sm shadow-md shadow-gray-500 text-style">ورود</button>
                        </div>
                    </form>
                    <!-- registerForm -->
                    <form x-show="formType=='register'" x-cloak id="registerForm" action="#" enctype="multipart/form-data" class="w-[800px] flex mt-10 gap-10 flex-col">
                        <div class="flex flex-row w-full gap-2">
                            ...
                            <div class="flex flex-col flex-1 gap-2">
                                <!-- name -->
                                <div class="flex flex-row justify-end gap-1">
                                    <label for="name" class="after:content-['*'] after:text-red-500 text-style flex items-center">نام</label>
                                    <input autocomplete="off" type="text" id="name"  name="name" class="w-3/4 px-3 bg-gray-200 rounded-md text-style h-9 focus:ring-0 focus:outline-none">
                                </div>
                                <!-- lastname -->
                                <div class="flex flex-row justify-end gap-1">
                                    <label for="lastname" class="after:content-['*'] after:text-red-500 text-style flex items-center">نام خانوادگی</label>
                                    <input autocomplete="off" type="text" id="lastname"  name="lastname" class="w-3/4 px-3 bg-gray-200 rounded-md text-style h-9 focus:ring-0 focus:outline-none">
                                </div>
                                <!-- meliCode -->
                                <div class="flex flex-row justify-end gap-1">
                                    <label for="melicode" class="after:content-['*'] after:text-red-500 text-style flex items-center">شماره ملی</label>
                                ...
                                <!-- phone -->
                                <div class="flex flex-row justify-end gap-1">
                                    <label for="phone" class="after:content-['*'] after:text-red-500 text-style flex items-center">موبایل</label>
                                ...
                                <!-- email -->
                                <div class="flex flex-row justify-end gap-1">
                                    <label for="email" class="after:content-['*'] after:text-red-500 text-style flex items-center">ایمیل</label>
                                ...
                                <!-- degri -->
                                <div class="flex flex-row justify-end gap-1">
                                    <label for="degri" class="after:content-['*'] after:text-red-500 text-style flex items-center">مقطع تحصیلی</label>
                                    <select name="degri" id="degri" class="w-3/4 px-2 bg-gray-100 rounded-md text-style h-9 focus:ring-0 focus:outline-none">
                            ...
                            <div class="flex-col flex-1">
                                ...
                                <div class="flex flex-col gap-2">
                                    <!-- field -->
                                    <div class="flex flex-row justify-end gap-1">
                                        <label for="field" class="after:content-['*'] after:text-red-500 text-style flex items-center">رشته تحصیلی</label>
                                        <select name="field" id="field" class="w-3/4 px-2 bg-gray-100 rounded-md text-style h-9 focus:ring-0 focus:outline-none">
                                    ...
                                    <!-- degri -->
                                    <div class="flex flex-row justify-end gap-1">
                                        <label for="trend" class="after:content-['*'] after:text-red-500 text-style flex items-center">گرایش</label>
                                        <select name="trend" id="trend" class="w-3/4 px-2 bg-gray-100 rounded-md text-style h-9 focus:ring-0 focus:outline-none">
                                            <option selected disabled>مقطع تحصیلی </option>
                                            <option value="1">کارشناسی ارشد</option>
                                            <option value="2">کارشناسی ناپیوسته</option>
                                        </select>
                        ...
                        <!-- submit -->
                        <div class="w-full flex-center">
                            <button class="px-10 py-2 text-white bg-green-600 rounded-sm shadow-md shadow-gray-500 text-style">ثبت نام</button>
                        </div>
                    </form>
                    <!-- close register -->
                    ...
                    <ul x-show="formType=='login'" class="absolute flex flex-col gap-3 list-disc -bottom-20 right-5">
                        <li class="text-style">نام کاربری شماره دانشجویی و رمز عبور شماره ملی می باشد.</li>
                        <li class="text-style">از کیبورد انگلیسی استفاده کنید.</li>
                    </ul>
                    <ul x-show="formType=='register'" class="absolute flex flex-col gap-3 list-disc -bottom-10 right-5">
                        <li class="text-style">موارد دارای * نباید خالی باشند.</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center h-full gap-2">
            ...
            <div class="flex items-center h-full">
                <span class="font-serif text-sm font-bold ">شبیه سازی سیستم گلستان دانشگاه صنعتی اصفهان</span>
            </div>
        </div>
        <!-- end logo -->
    </section>
...
<main class="w-full p-16">
    ...
    <div class="flex flex-col gap-5">
        <h1 class="font-serif text-lg font-bold">اخبار و اطلاعیه ها</h1>
        <ul class="flex flex-col gap-5 px-4 font-bold list-disc text-style">
