...
@endif
@if($errors->any())
    <div id="box_error" class="absolute bg-opacity-50 shadow-md shadow-gray-400  backdrop-blur-sm flex flex-col text-xs top-32 left-5 bg-red-600 rounded-sm flex p-2 px-5 justify-center items-start gap-2 text-white">
