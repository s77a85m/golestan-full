...
@section('content')
    ...
    <!--            content -->
    <div class="w-full py-5 px-10 h-full flex justify-between flex-col">
        <!--        table -->
                        ...
                        <tr class="text-xs">
                            ...
                            <td class="border-2 p-2 border-gray-300 border-b-0 border-l-0">
                                <div class="flex justify-center items-center gap-2 flex-row">
                                    <!-- edit -->
                                    <button class="p-1 bg-amber-500 w-8 flex-center rounded-sm text-white">
                                    ...
                                    <!-- delete -->
                                    <button class="p-1 w-8 bg-red-500 flex-center rounded-sm text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
